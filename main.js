...
// document here is referring to the DOM (Document Object Model), .hero is the class name of the form, 
// and form is the tag name of the form.  This tell JS to go find a form element that inside an element 
...
// .hero is the class name of the h1 tag, and strong is the tag name of the strong tag. So here we are 
// referring to the strong tag inside the h1 tag which is inside the hero section.
